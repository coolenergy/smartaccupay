...
Client.prototype.authenticateWithCorrectUsernameAndPassword = function(callback) {
    console.log('authenticateWithCorrectUsernameAndPassword =============>');
    var args = {
        strUserName: configData.QB_USERNAME,
        strPassword: configData.QB_PASSWORD
    };
    console.log('authenticateWithCorrectUsernameAndPassword =============>', args);
