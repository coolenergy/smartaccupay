import { Component, Injectable, Input, EventEmitter, Output, ElementRef } from '@angular/core';
...
export class AlertComponent {
  ...
  visibility = 'visible';
  gif = '../assets/images/rovuk-gif.gif';
  ...
  constructor (private host: ElementRef<HTMLElement>) {
    const temp_gif = localStorage.getItem(localstorageconstants.INVOICE_GIF);
